...
void esa_retrieval(RetrievalInputTensor input, RetrievalOutputTensor output){
    ...
    AT_DISPATCH_FLOATING_TYPES_AND2(at::ScalarType::Half, at::ScalarType::BFloat16, repre_cache.scalar_type(), "esa_retrieval_cuda", ([&] {
        if constexpr (std::is_same_v<scalar_t, float>) {
            auto* Q_ptrs = reinterpret_cast<float**>(q_ptrs.data_ptr<int64_t>());
            retrieval_kernel_fp32<<<numBlocks, numThreads, bytes>>>(Q_ptrs, reinterpret_cast<float*>(repre_cache.data_ptr()), reinterpret_cast<float*>(score.data_ptr()), repre_index.data_ptr<int>(), q_index.data_ptr<int>(), num_q_heads, num_k_heads, dim, s);
            void* temp_workspace = nullptr;
            size_t temp_bytes = 0;
            cub::DeviceSegmentedRadixSort::SortPairsDescending(
                    temp_workspace, temp_bytes,
            ...
            auto* Q_ptrs = reinterpret_cast<__half**>(q_ptrs.data_ptr<int64_t>());
            retrieval_kernel_fp16<<<numBlocks, numThreads, bytes>>>(Q_ptrs, reinterpret_cast<__half*>(repre_cache.data_ptr()), reinterpret_cast<__half*>(score.data_ptr()), repre_index.data_ptr<int>(), q_index.data_ptr<int>(), num_q_heads, num_k_heads, dim, s);
            void* temp_workspace = nullptr;
            size_t temp_bytes = 0;
            cub::DeviceSegmentedRadixSort::SortPairsDescending(
                    temp_workspace, temp_bytes,
            ...
            auto* Q_ptrs = reinterpret_cast<__nv_bfloat16**>(q_ptrs.data_ptr<int64_t>());
            retrieval_kernel_bf16<<<numBlocks, numThreads, bytes>>>(Q_ptrs, reinterpret_cast<__nv_bfloat16*>(repre_cache.data_ptr()), reinterpret_cast<__nv_bfloat16*>(score.data_ptr()), repre_index.data_ptr<int>(), q_index.data_ptr<int>(), num_q_heads, num_k_heads, dim, s);
            void* temp_workspace = nullptr;
            size_t temp_bytes = 0;
            cub::DeviceSegmentedRadixSort::SortPairsDescending(
                    temp_workspace, temp_bytes,
